...
## POST [/v3.0](https://developer.jamendo.com/v3.0)/setuser [/favorite](https://developer.jamendo.com/v3.0/setuser/favorite)
...
| track\_id | integer | The trackid which should be added to favorite |
