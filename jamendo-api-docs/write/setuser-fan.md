...
## POST [/v3.0](https://developer.jamendo.com/v3.0)/setuser [/fan](https://developer.jamendo.com/v3.0/setuser/fan)

### Description

Use this method to let the user identified by 'userid' become a fan of the artist identified 'artistid' (/users/artists?relation='fan'). Note that if the artist doesn't exist, no error will be raised, but the track will not appear in any read request of api and website.

### Required parameters

_client\_id && access\_token && artist\_id_
